...
{
    ParserOld::ParserOld(std::vector<Token>& tokens)
        : m_Tokens{ tokens }, m_Current{ tokens.begin() }
    {
    }

    Token& ParserOld::advance()
    {
        if(!isAtEnd())
    ...
    Token& ParserOld::previous()
    {
        return m_Current != m_Tokens.begin() ? *std::prev(m_Current) : *m_Current;
    }

    Token& ParserOld::peek()
    {
        return *m_Current;
    }

    Token& ParserOld::consume(TokenType type, const std::string& errorMsg)
    {
        if(check(type))
            return advance();
    ...
    bool ParserOld::isAtEnd()
    {
        return m_Current->type == TokenType::END;
    }

    bool ParserOld::check(TokenType type)
    {
        return isAtEnd() ? false : peek().type == type;
    }

    bool ParserOld::check(const std::vector<TokenType>& types)
    {
    ...
    bool ParserOld::match(const TokenType& type)
    {
        if (check(type)) {
            advance();
            return true;
    ...
    bool ParserOld::match(const std::vector<TokenType>& types)
    {
    ...
    std::vector<std::unique_ptr<Stmt>>& ParserOld::parse()
    {
        while(!isAtEnd())
        {
    ...
    std::vector<std::unique_ptr<Stmt>> ParserOld::parseBlock()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseDeclaration()
    {
        try
        {
    ...
    std::pair<Token, Token> ParserOld::parseNewVariable()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseVariableDeclaration()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseStatement()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseExpressionStatement()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseFunctionStatement(const std::string& kind)
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseReturnStatement()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parsePrintStatement()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseForStatement()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseWhileStatement()
    {
    ...
    std::unique_ptr<Stmt> ParserOld::parseIfStatement()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseExpression()
    {
        return parseAssignmentExpr();
    }

    std::unique_ptr<Expr> ParserOld::parseAssignmentExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseOrExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseAndExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseEqualityExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseComparisonExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseAdditiveExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseMultiplicativeExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseUnaryExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parseCallExpr()
    {
    ...
    std::unique_ptr<Expr> ParserOld::parsePrimaryExpr()
    {
        if (match({
    ...
    std::unique_ptr<Expr> ParserOld::finishCall(std::unique_ptr<Expr> callee)
    {
    ...
    std::string ParserOld::syntaxErrorMsg(const std::string& filename, const Token& token, const std::string& msg)
    {
        return "<"+filename+">:" +
